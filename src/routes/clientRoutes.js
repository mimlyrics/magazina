const BASE_URL = "https://magazina.onrender.com";
...
const CLIENT_URL = {
    ...
    MANAGER_CATEGORY_URL: `${BASE_URL}/manager/category`,
...
export const {MANAGER_ADD_CATEGORY_URL, MANAGER_ADD_PRODUCT_URL, MANAGER_EDIT_CATEGORY_URL, MANAGER_EDIT_PRODUCT_URL,
    MANAGER_PRODUCTS_URL,MANAGER_URL, ADMIN_ADD_ORDERS_ITEM_URL, ADMIN_ADD_ORDERS_URL, ADMIN_ADD_SUPPLIER_URL,
    MANAGER_CATEGORY_URL, ADMIN_CUSTOMERS_URL, ADMIN_EDIT_SUPPLIER_URL, ADMIN_ORDERS_URL, ADMIN_SUPPLIERS_URL,
    MANAGER_ADD_STOCK_URL_ByProductId, CART_URL,
