...
const BASE_URL = "https://magazina-api.onrender.com";
const SU = "https://magazina-api.onrender.com/api/v1";
...
export const  {REGISTER_URL, LOGIN_URL, MOVEMENT_TYPE_URL, CUSTOMER_URL, CATEGORY_URL, STATUS_URL, USERS_URL, PRODUCT_CATEGORY_URL, PRODUCT_URL, STOCK_URL, ORDER_URL, ORDER_ITEM_URL, SUPPLIER_URL} = SERVER_URL;
